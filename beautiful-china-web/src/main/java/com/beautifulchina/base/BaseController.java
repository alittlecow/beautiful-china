...
public class BaseController implements MessageSourceAware {
    ...
    protected Map<String, Object> failResult() {
        return createJson(false, RESCODE_FAIL, getMessage(CommonErrorCode.FAILURE), Collections.EMPTY_MAP);
    }
    ...
    protected Map<String, Object> successResult() {
        return createJson(true, RESCODE_OK, getMessage(CommonErrorCode.SUCCESS), Collections.EMPTY_MAP);
    }
